...
public class LoggingAspect {
	...
	// コントロール
	@Pointcut("execution(public * com.example.apigateway.controller..*.*(..)) && within(@org.springframework.web.bind.annotation.RestController *) ")
	public void controllerPointcut() {
	}

	// サービス
	@Pointcut("execution(public * com.example.apigateway.controller..*.*(..)) && within(@org.springframework.stereotype.Service *) ")
